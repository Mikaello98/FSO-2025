  ...
  describe('When logged in', () => {
    ...
    describe('and multiple blogs exist', () => {
      ...
      test('blogs are ordered by likes', async ({ page }) => {
        ...
        await expect(blogDivs[0]).toContainText('blog2 by Ted Tester') 
        await expect(blogDivs[1]).toContainText('blog3 by Ted Tester') 
        await expect(blogDivs[2]).toContainText('blog1 by Ted Tester') 
      })
